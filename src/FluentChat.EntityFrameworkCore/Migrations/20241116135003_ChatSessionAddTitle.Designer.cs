...
{
    [DbContext(typeof(FluentChatDbContext))]
    [Migration("20241116135003_ChatSessionAddTitle")]
    partial class ChatSessionAddTitle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluentChat.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FluentChat.Models.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FluentChat.Models.ChatMessage", b =>
                {
                    b.HasOne("FluentChat.Models.ChatSession", "Session")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("FluentChat.Models.ChatSession", b =>
                {
                    b.OwnsOne("FluentChat.Chat.PromptSettings", "PromptSettings", b1 =>
                        {
                            b1.Property<Guid>("ChatSessionId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ChatSessionId");

                            b1.ToTable("ChatSessions");

                            b1.ToJson("PromptSettings");
